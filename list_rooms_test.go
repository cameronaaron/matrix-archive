...
func TestListRooms_ValidPattern(t *testing.T) {
	...
	err := listRooms("NonExistentRoomPattern123456789")
...
func TestGetRoomDisplayName(t *testing.T) {
	...
	displayName, err := getRoomDisplayName(mockClient, "!nonexistent:example.com")
...
func TestGetRoomDisplayName_WithContext(t *testing.T) {
	...
	displayName, err := getRoomDisplayName(mockClient, "!timeout:example.com")
